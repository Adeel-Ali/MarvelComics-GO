 ...
 */
type COMICS_IMPL struct { }

/**
 * Fetches a single comic by id.
 * @param    string        comicId     parameter: Required
 * @return	Returns the *models_pkg.Comic response from the API call
 */
func (me *COMICS_IMPL) GetComicIndividual (
            comicId string) (*models_pkg.Comic, error) {
   ...
   _queryBuilder = _queryBuilder + "/comics/{comicId}"
    ...
    if (_response.Code == 404) {
        err = apihelper_pkg.NewAPIError("Comic not found.", _response.Code, _response.RawBody)
    ...
    var retVal *models_pkg.Comic = &models_pkg.Comic{}
 ...
 */
func (me *COMICS_IMPL) GetComicCharacterCollection (
            comicId string,
            events *string,
            limit *string,
 ...
 */
func (me *COMICS_IMPL) GetCreatorCollectionByComicId (
            comicId string,
            comics *string,
            firstName *string,
 ...
 */
func (me *COMICS_IMPL) GetIssueEventsCollection (
            comicId string,
            characters *string,
            creators *string,
            limit *string,
 ...
 */
func (me *COMICS_IMPL) GetComicStoryCollectionByComicId (
            comicId string,
            characters *string,
            creators *string,
            events *string,
