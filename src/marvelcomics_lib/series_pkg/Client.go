 ...
 */
type SERIES_IMPL struct { }

/**
 * Fetches a single comic series by id.
 * @param    string        seriesId     parameter: Required
 * @return	Returns the *models_pkg.Series response from the API call
 */
func (me *SERIES_IMPL) GetSeriesIndividual (
            seriesId string) (*models_pkg.Series, error) {
   ...
   _queryBuilder = _queryBuilder + "/series/{seriesId}"
    ...
    if (_response.Code == 404) {
        err = apihelper_pkg.NewAPIError("Series not found.", _response.Code, _response.RawBody)
    ...
    var retVal *models_pkg.Series = &models_pkg.Series{}
 ...
 */
func (me *SERIES_IMPL) GetSeriesCharacterWrapper (
            seriesId string,
            comics *string,
            events *string,
            limit *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/series/{seriesId}/characters"
 ...
 */
func (me *SERIES_IMPL) GetComicsCollectionBySeriesId (
            seriesId string,
            characters *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/series/{seriesId}/comics"
 ...
 */
func (me *SERIES_IMPL) GetCreatorCollectionBySeriesId (
            seriesId string,
            comics *string,
            events *string,
            firstName *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/series/{seriesId}/creators"
 ...
 */
func (me *SERIES_IMPL) GetEventsCollectionBySeriesId (
            seriesId string,
            characters *string,
            comics *string,
            creators *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/series/{seriesId}/events"
 ...
 */
func (me *SERIES_IMPL) GetSeriesStoryCollection (
            seriesId string,
            characters *string,
            comics *string,
            creators *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/series/{seriesId}/stories"
...
func (me *SERIES_IMPL) GetSeriesCollection (
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/series"
