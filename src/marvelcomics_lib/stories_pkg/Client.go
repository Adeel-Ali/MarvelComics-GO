 ...
 */
type STORIES_IMPL struct { }

/**
 * Fetches a single comic story by id.
 * @param    string        storyId     parameter: Required
 * @return	Returns the *models_pkg.Story response from the API call
 */
func (me *STORIES_IMPL) GetStoryIndividual (
            storyId string) (*models_pkg.Story, error) {
        //the base uri for api requests
    _queryBuilder := marvelcomics_lib.BASEURI;

    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/stories/{storyId}"
    ...
    if (_response.Code == 404) {
        err = apihelper_pkg.NewAPIError("Story not found.", _response.Code, _response.RawBody)
    ...
    var retVal *models_pkg.Story = &models_pkg.Story{}
 ...
 */
func (me *STORIES_IMPL) GetCharacterCollectionByStoryId (
            storyId string,
            comics *string,
            events *string,
            limit *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/stories/{storyId}/characters"
 ...
 */
func (me *STORIES_IMPL) GetComicsCollectionByStoryId (
            storyId string,
            characters *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/stories/{storyId}/comics"
 ...
 */
func (me *STORIES_IMPL) GetCreatorCollectionByStoryId (
            storyId string,
            comics *string,
            events *string,
            firstName *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/stories/{storyId}/creators"
 ...
 */
func (me *STORIES_IMPL) GetEventsCollectionByStoryId (
            storyId string,
            characters *string,
            comics *string,
            creators *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/stories/{storyId}/events"
 ...
 */
func (me *STORIES_IMPL) GetStorySeriesCollection (
            storyId string,
            characters *string,
            comics *string,
            contains *string,
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/stories/{storyId}/series"
...
func (me *STORIES_IMPL) GetStoryCollection (
    ...
    //prepare query string for API call
   _queryBuilder = _queryBuilder + "/stories"
