 ...
 */
type CREATORS_IMPL struct { }

/**
 * Fetches a single creator by id.
 * @param    string        creatorId     parameter: Required
 * @return	Returns the *models_pkg.Creator response from the API call
 */
func (me *CREATORS_IMPL) GetCreatorIndividual (
            creatorId string) (*models_pkg.Creator, error) {
   ...
   _queryBuilder = _queryBuilder + "/creators/{creatorId}"
    ...
    if (_response.Code == 404) {
        err = apihelper_pkg.NewAPIError("Creator not found.", _response.Code, _response.RawBody)
    ...
    var retVal *models_pkg.Creator = &models_pkg.Creator{}
 ...
 */
func (me *CREATORS_IMPL) GetComicsCollectionByCreatorId (
            creatorId string,
            characters *string,
 ...
 */
func (me *CREATORS_IMPL) GetCreatorEventsCollection (
            creatorId string,
            characters *string,
            comics *string,
            limit *string,
 ...
 */
func (me *CREATORS_IMPL) GetCreatorSeriesCollection (
            creatorId string,
            characters *string,
            comics *string,
            contains *string,
 ...
 */
func (me *CREATORS_IMPL) GetCreatorStoryCollection (
            creatorId string,
            characters *string,
            comics *string,
            events *string,
